...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/parserutils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14640&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/parserutils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `parserutils` can be installed with:

```
conda install parserutils
```

It is possible to list all of the versions of `parserutils` available on your platform with:
